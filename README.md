# generator-config-generics (`@veams/generator-config-generics`)
> Sub-Generator :: Simple Generator to Scaffold Generic Files.
...
```bash
npm install @veams/generator-config-generics --dev
```

### Yarn 

```bash
yarn add @veams/generator-config-generics
```
...
module.exports = class extends Generator {
	...
	initializing() {
		this.composeWith(require.resolve('generator-config-generics'), {
			__store: this.config
		});
